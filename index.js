    ...
    hooks: {
        ...
        "page": function (page) {
            ...
            if (level == 4 && len == 3) {
                ...
                demo = '<h2 id="Demo 示例">Demo 示例</h2><iframe style="border:1px solid #CCC;width:375px;height:667px;" src=\'//taobaofed.github.io/demo/tile-components/index.html?isSingle=true&demo=' + modName + '\'></iframe>';
            }
            if (level == 5 && len >= 3) {
                modName = page.title.split(' ')[0].toLowerCase();
                partName = page.path.split('/')[1];demo = '<h2 id="Demo 示例">Demo 示例</h2><iframe style="border:1px solid #CCC;width:375px;height:667px;" src=\'//taobaofed.github.io/demo/tile-modules/index.html?isSingle=true&part=' + partName + '&demo=' + modName + '\'></iframe>';
            }
            page.content += demo;
            return page;
        },
